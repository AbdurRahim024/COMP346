         ...
         { 
        	 ...
        	 if (!objNetwork.getInBufferStatus().equals("empty"))
        	 {
        		 ...
        		 if (trans.getOperationType().equals("DEPOSIT"))
        		 {
        		  ...
        		  while((objNetwork.getOutBufferStatus().equals("full")) && !objNetwork.getClientConnectionStatus().equals("disconnected")) {Thread.yield();} /* Alternatively,  busy-wait until the network output buffer is available */
