...
public class Client extends Thread{ 
    ...
    {   
    	...
    	if(clientOperation.equals("sending")){
            ...
            System.out.println("The time it took to send is " + (sendClientEndTime - sendClientStartTime) + " milliseconds");
            return;
        }
        ...
        if (clientOperation.equals("receiving")){
            ...
            System.out.println("The time it took to receive is " + (receiveClientEndTime - receiveClientStartTime) + " milliseconds");
        }
